  ...
  beforeEach(function(done) {
    ...
    request(app)
      ...
      .end(function(err, res) {
        ...
        Link.findOneAndRemove( { url: 'http://www.roflzoo.com/'}, function (err) {
          if (err) { throw err; }
        });
        User.findOneAndRemove( { username: 'Savannah'}, function (err) {
          if (err) { throw err; }
        });
        User.findOneAndRemove( { username: 'Phillip'}, function (err) {
          if (err) { throw err; }
        });
